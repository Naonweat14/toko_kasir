...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-indigo navbar-indigo">
    <div class="container">
      <a href="../../index3.html" class="navbar-brand">
        <span class="brand-text font-weight-indigo"><i class="fas fa-shopping-cart text-light"></i><b> Transaksi Penjualan</b></span>
      </a>
        ...
        <div class="row">
              ...
              <div class="card-body">
               ...
               <div class="col-3">
                <div class="form-group">
                    ...
                    <label class="form-control form-control-lg text-indigo"><?= $no_faktur ?></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                    <label>Tanggal</label>
                    <label class="form-control form-control-lg text-indigo"><?= date('d M Y') ?></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                    <label>Jam</label>
                    <label class="form-control form-control-lg text-indigo" id="jam"></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                    <label>Kasir</label>
                    <label class="form-control form-control-lg text-indigo"><?= session()->get('nama_user') ?></label>
                  </div>
                </div>
          ...
          <div class="col-lg-5">
            <div class="card card-indigo card-outline">
              ...
              <div class="card-body bg-indigo color-palette text-right">
              <label class="display-4 text-light">Rp. <?= number_format($grand_total, 0) ?>.-</label>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="card card-indigo card-outline">
              ...
              <div class="card-body bg-indigo color-palette text-indigo">
              <h1 class="text-light" id="terbilang"></h1>
              </div>
            </div>
          </div>
          <div class="col-12">
            ...
            <table id="example1" class="table table-bordered table-striped text-sm">
                ...
                <tbody>
                     ...
                     <tr>
                         ...
                         <td><?= $value['stok'] ?></td>
                         <td>
                          <button onclick="PilihProduk(<?= $value['kode_produk'] ?>)" class="btn btn-success btn-xs">Pilih</button></td>
                     </tr>
                     <?php } ?>
                </tbody>
               </table>   
          ...
          <div class="modal-content">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input name="dibayar" id="dibayar" class="form-control formt-control-lg text-right text-success" autocomplete="off">
              </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <input name="kembalian" id="kembalian" class="form-control formt-control-lg text-right text-primary" readonly>
              </div>
              </div>

            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary btn-flat"><i class ="fas-fa"></i>Save Transaksi</button>
            </div>
            <?php echo form_close() ?>
          </div>
          </div>
